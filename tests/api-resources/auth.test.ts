...
describe('resource auth', () => {
  ...
  test.skip('requestNonce: only required params', async () => {
    const responsePromise = client.auth.requestNonce({ wallet_address: '0x1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('requestNonce: required and optional params', async () => {
    const response = await client.auth.requestNonce({ wallet_address: '0x1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b' });
  });
  ...
  test.skip('verifySignature: only required params', async () => {
    const responsePromise = client.auth.verifySignature({ signature: '0xabcdef...', wallet_address: '0x1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
